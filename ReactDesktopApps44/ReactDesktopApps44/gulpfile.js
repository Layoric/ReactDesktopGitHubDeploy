...
(function () {
    ...
    var resourcesRoot = '../ReactDesktopApps44.Resources/';
    var webRoot = 'wwwroot/';
	...
	var winFormsAssemblyInfoPath = '../ReactDesktopApps44.AppWinForms/Properties/AssemblyInfo.cs';
    ...
    gulp.task('www-copy-resources-lib', function() {
        return gulp.src('../ReactDesktopApps44.Resources/bin/Release/ReactDesktopApps44.Resources.dll')
    ...
    gulp.task('www-msbuild-web', function() {
        return gulp.src('./ReactDesktopApps44.csproj')
            .pipe(msbuild({
    ...
    gulp.task('www-msbuild-resources', function () {
        return gulp.src('../ReactDesktopApps44.Resources/ReactDesktopApps44.Resources.csproj')
            .pipe(msbuild({
                targets: ['Clean', 'Rebuild'],
                properties: {
                    Configuration: 'Release'
    ...
    gulp.task('www-msbuild-console', function () {
        return gulp.src('../ReactDesktopApps44.AppConsole/ReactDesktopApps44.AppConsole.csproj')
            .pipe(msbuild({
                targets: ['Clean', 'Rebuild'],
                properties: {
                    Configuration: 'Release'
    ...
    gulp.task('www-msbuild-winforms', function () {
        return gulp.src('../ReactDesktopApps44.AppWinforms/ReactDesktopApps44.AppWinforms.csproj')
            .pipe(msbuild({
                targets: ['Clean', 'Rebuild'],
                properties: {
                    Configuration: 'Release'
    ...
    gulp.task('www-nuget-restore', function() {
        return gulp.src('../../ReactDesktopApps44.sln')
            .pipe(nugetRestore());
    });
...
gulp.task('www-nuget-pack-winforms', function (callback) {
        ...
        var excludes = globule.find([
            '../ReactDesktopApps44.AppWinForms/bin/x86/Release/*.pdb',
            '../ReactDesktopApps44.AppWinForms/bin/x86/Release/*.vshost.*'
        ]);
        var includes = [
        { src: '../ReactDesktopApps44.AppWinForms/bin/x86/Release/*.*', dest: '/lib/net45/' },
        { src: '../ReactDesktopApps44.AppWinForms/bin/x86/Release/locales/*.*', dest: '/lib/net45/locales/' }];
        return nugetpack({
            id: title,
            title: title,
                version: version,
