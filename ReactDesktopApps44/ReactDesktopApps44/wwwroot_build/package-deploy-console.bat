...
SET TOOLS=.\tools
SET OUTPUTNAME=ReactDesktopApps44-console.exe
SET ILMERGE=%TOOLS%\ILMerge.exe
SET RELEASE=..\..\ReactDesktopApps44.AppConsole\bin\Release
SET INPUT=%RELEASE%\ReactDesktopApps44.AppConsole.exe
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps44.Resources.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps44.ServiceInterface.dll
SET INPUT=%INPUT% %RELEASE%\ReactDesktopApps44.ServiceModel.dll
